		...
		<view class="home-cont">
			...
			<view class="app-model">
				<view class="model-box">
					<view class="" @click="jumpMenu(2)">
						<image
							class="take-pic"
							src="../../static/homepage/home_takeit_pic.png"
							mode=""
						></image>
						<text>门店自取</text>
					...
					<view class="" @click="jumpMenu(1)">
						<image
							class="take-pic"
							src="../../static/homepage/home_takeout_pic.png"
						></image>
						<text>外卖</text>
			...
			<view class="active_card" @click="jumpClissIfy(1)" v-if="member">
				<view class="card_l">
					<image
						class="card_icon"
						src="../../static/homepage/home_inter_icon.png"
					></image>
					<text>积分商城</text>
				</view>
				<view class="card_r">
...
.integral {
	...
	.integral_f {
		...
		background: $bg-white
			url(https://fnb-merchants.oss-cn-shanghai.aliyuncs.com/miniAppSetting/b3a2e7b3e5227e1e1ba86c8a5c5b150.png)
			no-repeat;
		background-size: cover;
		@extend %integral;
	}
	...
	.box-r {
		...
		.integral_s {
			...
			background: $bg-white
				url(https://fnb-merchants.oss-cn-shanghai.aliyuncs.com/miniAppSetting/d95e99296259695998bffdce64541e2.png)
				no-repeat;
			background-size: cover;
			margin-bottom: 16upx;
			@extend %integral;
		...
		.integral_t {
			@include rect(100%, 200upx);
			background: $bg-white
				url(https://fnb-merchants.oss-cn-shanghai.aliyuncs.com/miniAppSetting/b2b95be2f4f202508436db72c10f174.png)
				no-repeat;
			background-size: cover;
