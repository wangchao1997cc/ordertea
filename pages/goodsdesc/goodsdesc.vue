	...
	<view class="content">
		<view class="head-info" v-if="goodsdesc.getWay!=0">
			...
			<view class="cost-item">
				...
				<text v-if="goodsdesc.getWay==1">{{businessinfo.name}}</text>
				<input v-else type="text" placeholder="请输入姓名" v-model="params.name" />
			</view>
			<view class="cost-item">
				<text>联系电话</text>
				<input type="text" placeholder="请输入手机号码" v-model="params.mobile" />
			</view>
