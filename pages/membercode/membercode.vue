<template>
	<view class="content">
		<view class="memberinfo">
			<view class="header-pic"><open-data type="userAvatarUrl"></open-data></view>
			<view class="user-name">{{ memberinfo.name }}</view>
...
import { toBarcode, toQrcode } from '../../utils/membercode.js';
